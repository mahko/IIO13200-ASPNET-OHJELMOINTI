...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
    ...
    <!-- Gv Controlli näyttää dataa -->
    <asp:GridView ID="gvMovies" DataSourceID="srcMovies" runat="server" HeaderStyle-BackColor="Blue" HeaderStyle-ForeColor="White" AutoGenerateColumns="False">
        <Columns>
