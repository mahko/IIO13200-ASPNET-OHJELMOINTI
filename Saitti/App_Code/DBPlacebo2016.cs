...
namespace JAMK.ICT.Data
{
    public static class DBPlacebo
    {
        ...
        public static DataTable getCitiesFromMysql(string cs)
        {
            try
            {
                //yhteys labranettiin ja palauttaa taulun
                string sql = "SELECT KayttajaId, KayttajaNick, KayttajaSalasana FROM Kayttaja ORDER BY KayttajaId DESC";
